        ...
        AAOptions()
                ...
                .title(AATitle()
                        ...
                        .style(AAStyle()
                                ...
                                .fontWeight(.bold)))
                .subtitle(AASubtitle()
                        .text("https://en.wikipedia.org/wiki/List_of_countries_by_largest_historical_GDP")
                        .align(.left)
                        .style(AAStyle()
                                .color(AAColor.white)
                                .fontWeight(.bold)))
...
//                                .lineWidth(4)
                ...
                .series([
                    ...
                    AASeriesElement()
                            .name("Russia")
                            .data([NSNull(), NSNull(), NSNull(), 6, 7, 6, 6, 6, 6]),
                    AASeriesElement()
                            .name("Indonesia")
                            .data([NSNull(), NSNull(), NSNull(), NSNull(), NSNull(), NSNull(), NSNull(), 8, 7]),
                    AASeriesElement()
                            .name("Brazil")
                            .data([7, 7, 9, 9, 9, 7, 7, 7, 8]),
                    AASeriesElement()
