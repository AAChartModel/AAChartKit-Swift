//
//  CustomStyleForBubbleChartComposer.swift
//  AAInfographicsDemo
//
    ...
    static func showAARadialGradientPositionAllEnumValuesWithBubbleChart() -> AAChartModel {
        AAChartModel()
            ...
            .colorsTheme([
                ...
                AAGradientColor.radialGradient(position: .middleLeft,   startColor: AAColor.red, endColor: AAColor.yellow),
                AAGradientColor.radialGradient(position: .middleCenter, startColor: AAColor.red, endColor: AAColor.yellow),
                AAGradientColor.radialGradient(position: .middleRight,  startColor: AAColor.red, endColor: AAColor.yellow),
